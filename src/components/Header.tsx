        ...
        <div className="flex justify-between items-center h-16">
          ...
          <a href="/" className="flex items-center space-x-3 group">
            <div className="flex-shrink-0">
              <svg className="h-8 w-8 text-blue-600 dark:text-blue-400 group-hover:text-blue-700 dark:group-hover:text-blue-300 transition-colors" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="ml-auto flex items-center space-x-4">
            ...
            {currentUser ? (
              <button
                onClick={logout}
                className="flex items-center space-x-2 bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-4 py-2 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors text-sm font-medium cursor-pointer"
              >
                <span>Sign out</span>
              </button>
            ) : (
